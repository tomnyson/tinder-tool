const i18n = {
  ...
  t(key) {
    return (
      (this.translations[this.lang] && this.translations[this.lang][key]) ||
  ...
  translations: {
    vi: {
      ...
      // Time slot labels
      "timeSlot.morning": "Buổi sáng 🌅",
      "timeSlot.noon": "Buổi trưa 🌞",
      "timeSlot.evening": "Buổi tối 🌙",

      // Message tab
      "msg.sendMode": "Chế độ gửi tin nhắn",
      "msg.randomQuotes": "Gửi câu châm ngôn ngẫu nhiên",
      "msg.modeFixedShort": "Tin viết",
      "msg.modeRandomShort": "Danh sách",
      "msg.modeAiShort": "AI",
      "msg.sourceFixed": "Nguồn: nội dung bên dưới",
      "msg.sourceRandom": "Nguồn: danh sách câu",
      "msg.sourceAi": "Nguồn: AI cá nhân hoá",
      "msg.aiBulkNote": "Nguồn: AI cá nhân hoá theo hồ sơ hiện tại.",
      ...
      "msg.apiNoResponse": "API không phản hồi",
      ...
      "msg.noTitle": "Không có tiêu đề",
      "msg.delete": "Xóa",
      "msg.saveMessage": "Lưu tin",
      "msg.savedOk": "Đã lưu vào danh sách tin nhắn",
      ...
      "msg.noResponse": "Không nhận được phản hồi",
      "msg.processed": "Đã xử lý {n} mục",
      ...
      "default.systemPrompt":
        "Ban la mot nguoi viet tin nhan tan gai (gui tin nhan dau tien cho phu nu tren Tinder). Viet tin nhan than thien, tu nhien, hai huoc nhe, phu hop voi van hoa Viet Nam. Khong qua 100 ky tu. Khong dung emoji qua nhieu.",
      "default.userPrompt":
    ...
    en: {
      ...
      "msg.modeFixedShort": "Written",
      "msg.modeRandomShort": "List",
      "msg.modeAiShort": "AI",
      "msg.sourceFixed": "Source: message below",
      "msg.sourceRandom": "Source: message list",
      "msg.sourceAi": "Source: personalized AI",
      "msg.aiBulkNote": "Source: personalized AI from the current profile.",
      ...
      "msg.apiNoResponse": "API not responding",
      ...
      "msg.noTitle": "Untitled",
      "msg.delete": "Delete",
      "msg.saveMessage": "Save message",
      "msg.savedOk": "Saved to message list",
      ...
      "msg.noResponse": "No response received",
      "msg.processed": "Processed {n} items",
      ...
      // Default prompts (EN)
      "default.systemPrompt":
        "You are a skilled dating app message writer (sending first messages to women on Tinder). Write friendly, natural, light-humorous messages that fit Western dating culture. Under 100 characters. No excessive emojis.",
      "default.userPrompt":
        "Write an opening message for this person: {profile}. Keep it casual and natural.",
